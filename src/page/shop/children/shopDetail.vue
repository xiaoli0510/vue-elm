  ...
  <div class="rating_page">
    ...
    <transition name="fade">
      <section
        ...
        v-if="state.showlicenseImg"
        @click="state.showlicenseImg = false"
      >
        <img :src="imgBaseUrl + state.licenseImg" />
      </section>
    </transition>
...
const shopDetail = computed(() => {
  return storeState.state.shopDetail;
});

let storeState = useStore();

function showLicenseImg(img) {

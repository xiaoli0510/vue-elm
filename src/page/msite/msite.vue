...
<template>
  <div>
    <head-top signin-up="msite">
      ...
      <slot name="msite-title">
        <router-link to="/home" class="msite_title">
          <span class="title_text ellipsis">{{ state.msiteTitle }}</span>
        </router-link>
      </slot>
    </head-top>
    <nav class="msite_nav">
      <div class="swiper-container" v-if="state.foodTypes.length">
        <div class="swiper-wrapper">
          <div
            class="swiper-slide food_types_container"
            v-for="(item, index) in state.foodTypes"
            :key="index"
          >
            <router-link
              :to="{
            ...
            >
              <figure>
                <img :src="state.imgBaseUrl + foodItem.image_url" />
    ...
    <div class="shop_list_container">
      ...
      <shop-list v-if="state.hasGetData" :geohash="state.geohash"></shop-list>
    </div>
